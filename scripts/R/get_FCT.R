...
new=c('Babyfood, cereal, mixed, dry fortified', 'Beef, New Zealand, imported, variety meats and by-products, kidney, cooked, boiled', 'Beef, New Zealand, imported, variety meats and by-products liver, cooked, boiled', 'Beef, New Zealand, imported, variety meats and by-products, tongue, cooked, boiled', 'Beef, New Zealand, imported, variety meats and by-products, tripe uncooked, raw', 'Beverages, tea, green, brewed, regular', 'Cocoa mix, NESTLE, Rich Chocolate Hot Cocoa Mix', 'Beverages, coffee, brewed, prepared with tap water', 'Beverages, coffee, instant, regular, powder', 'Crustaceans, shrimp, mixed species, cooked, moist heat (may have been previously frozen)', 'Crustaceans, shrimp, cooked (not previously frozen)', 'Fish, cod, Pacific, cooked, dry heat (may have been previously frozen)', 'Fish, cod, Pacific, cooked (not previously frozen)', '', 'Fish, pollock, Alaska, cooked, dry heat (may have been previously frozen)', 'Fish, pollock, Alaska, cooked (not previously frozen)', 'Fish, salmon, sockeye, cooked, dry heat', 'Beverages, tea, hibiscus, brewed', 'Kiwifruit, ZESPRI SunGold, raw', 'Macaroni, vegetable, enriched, cooked', 'Pork sausage, link/patty, cooked, pan-fried', "Pasta, gluten-free, corn, cooked", 'Peaches, yellow, raw', 'Rice, white, glutinous, unenriched, cooked', 'Spices, mustard seed, ground', 'Spices, mustard seed, ground', 'Beverages, tea, black, brewed, prepared with tap water', 'Beverages, tea, herb, other than chamomile, brewed'))
